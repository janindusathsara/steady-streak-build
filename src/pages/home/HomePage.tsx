...
function Hero() {
  return (
    <section className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] pt-10 pb-14 sm:pt-16 sm:pb-20">
...
function Services() {
  return (
    <section id="services" className="bg-secondary/40 py-20">
      <div className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px]">
...
function CTA() {
  return (
    <section id="news" className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] py-16 sm:py-24">
