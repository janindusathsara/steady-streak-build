  ...
  if (!service) {
    return (
      <div className="min-h-screen bg-background text-foreground">
        <Navbar />
        <div className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] py-24 text-center">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] pt-10 pb-14 sm:pt-12 sm:pb-20">
      ...
      {/* Main */}
      <section className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] py-12">
                ...
                {filtered.map((p) => (
                  <div key={p.id} className="rounded-2xl border border-border bg-card p-5">
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-border pt-4">
                      ...
                      <Link {...providerBookFor(p.id)} className="rounded-lg bg-primary px-4 py-2 text-xs font-bold text-primary-foreground hover:opacity-90 transition-opacity">Book Now</Link>
                    </div>
                  </div>
                ))}
                {filtered.length === 0 && (
