  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-gradient-to-b from-primary/5 via-background to-background">
        <div className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] py-14 sm:py-20 text-center">
      ...
      {/* Categories */}
      <section className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] py-14">
      ...
      {/* Top rated providers */}
      <section className="mx-auto w-full max-w-6xl 4xl:max-w-[1800px] px-4 sm:px-5 3xl:max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2200px] 4xl:max-w-[1800px] pb-14">
